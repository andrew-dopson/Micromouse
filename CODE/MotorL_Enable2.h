...
#ifndef MotorL_Enable2_H_
#define MotorL_Enable2_H_
...
** ===================================================================
*/
#define MotorL_Enable2_ClrVal() ( \
    (void)clrReg8Bits(PTT, 0x02U)      /* PTT1=0x00U */, \
    (Shadow_T &= 0xFDU)                /* Set appropriate bit in shadow variable */ \
  )
...
** ===================================================================
*/
#define MotorL_Enable2_SetVal() ( \
    (void)setReg8Bits(PTT, 0x02U)      /* PTT1=0x01U */, \
    (Shadow_T |= 0x02U)                /* Set appropriate bit in shadow variable */ \
  )
...
/* END MotorL_Enable2. */
#endif /* #ifndef __MotorL_Enable2_H_ */
/*
** ###################################################################
**
