...
void LCD_RS_PutVal(bool Val)
{
  if (Val) {
    ...
    Shadow_A = (byte)0x01U;            /* Set-up shadow variable */
  } else { /* !Val */
    clrReg8Bits(PORTA, 0x01U);         /* BIT0=0x00U */
    Shadow_A = (byte)0x00U;            /* Set-up shadow variable */
  } /* !Val */
}
...
{
  if (Dir) {
    setReg8(PORTA, (getReg8(PORTA) & (byte)(~(byte)0x01U)) | Shadow_A); /* BIT0=Shadow_A[bit 0] */
    setReg8Bits(DDRA, 0x01U);          /* BIT0=0x01U */
  } else { /* !Dir */
    clrReg8Bits(DDRA, 0x01U);          /* BIT0=0x00U */
  } /* !Dir */
}
