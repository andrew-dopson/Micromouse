...
void LCD_EN_PutVal(bool Val)
{
  if (Val) {
    ...
    Shadow_E |= 0x80U;                 /* Set-up shadow variable */
  } else { /* !Val */
    clrReg8Bits(PORTE, 0x80U);         /* BIT7=0x00U */
    Shadow_E &= 0x7FU;                 /* Set-up shadow variable */
  } /* !Val */
}
...
{
  if (Dir) {
    setReg8(PORTE, (getReg8(PORTE) & (byte)(~(byte)0x80U)) | (Shadow_E & 0x80U)); /* BIT7=Shadow_E[bit 7] */
    setReg8Bits(DDRE, 0x80U);          /* BIT7=0x01U */
  } else { /* !Dir */
    clrReg8Bits(DDRE, 0x80U);          /* BIT7=0x00U */
  } /* !Dir */
}
